...
export interface IHomeworkClient {
    ...
    deleteHomeWorkAssignment(homeWorkAssignmentUpdateId?: string): Observable<void>;
}
...
export class HomeworkClient implements IHomeworkClient {
    ...
    deleteHomeWorkAssignment(homeWorkAssignmentUpdateId?: string): Observable<void> {
        const queryString = buildQueryString({
            homeWorkAssignmentUpdateId,
        });
        const url = `${Constants.apiAutoGeneratedRoot}/api/Homework/delete-homeWork-assignment${queryString}`;
