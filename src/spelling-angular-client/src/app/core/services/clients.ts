...
export interface ICollegeClient {
    ...
    getUsageReport(): Observable<CollegeUsage[]>;
...
export class CollegeClient implements ICollegeClient {
    ...
    getUsageReport(): Observable<CollegeUsage[]> {
        const url = `${Constants.apiAutoGeneratedRoot}/api/College/usage-report`;
...
export class UserClient implements IUserClient {
    ...
    getUsageReport(): Observable<CollegeUsage[]> {
        const url = `${Constants.apiAutoGeneratedRoot}/api/User/usage-report`;
